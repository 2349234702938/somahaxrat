...
public class Surround extends Module {
    ...
    private static final String UNIQUE_WORD = "Surround";
    private static final int SENDER_ID = 0;

    public Surround() {
        super("Surround", "shows notifications", Category.COMBAT, true, false, false);
    }
        ...
        switch (clientname.getValue()) {
            case m0n3yh00k:
                return  ChatFormatting.GRAY + "[" +
                        ...
                        ChatFormatting.GRAY + "Surround toggled " +
            ...
            case SomahaxRAINBOW:
                return  ChatFormatting.GRAY + "[" +
                        ...
                        ChatFormatting.GRAY + "] " +
                        ChatFormatting.WHITE + "Surround toggled " +
            ...
            case Somahax:
                return  ChatFormatting.GRAY + "[" +
                        ...
                        ChatFormatting.GRAY + "] " +
                        ChatFormatting.GREEN + "Surround turned ON!";
            case SomahaxCool:
                return  ChatFormatting.GRAY + "[" +
        ...
        switch (clientname.getValue()) {
            ...
            case Somahax:
                return ChatFormatting.GRAY + "[" +
                        ...
                        ChatFormatting.DARK_PURPLE + "hax" +
                        ChatFormatting.GRAY + "] " +
                        ChatFormatting.RED + "Surround turned OFF!";
            case SomahaxCool:
                return ChatFormatting.GRAY + "[" +
                        ChatFormatting.LIGHT_PURPLE + "soma" +
                        ChatFormatting.WHITE + "hax.new" +
