...
public class Replenish
    ...
    private final Setting<Integer> gapStack = this.register(new Setting<Integer>("GapStack", 1, 16, 48));
    private final Setting<Integer> xpStackAt = this.register(new Setting<Integer>("XPStack", 1, 16, 48));
